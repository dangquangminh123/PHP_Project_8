...
class Auth
{
	...
	{
		// kiểm tra session user có đăng nhập chưa
		if(!isset($_SESSION['USER']))
		{
			return false;
		}

		//Gắn giá trị rank vào cho biến logged_in_rank
		$logged_in_rank = $_SESSION['USER']->rank;

		//tạo các giá trị cho từng mảng rank
		...
		//Kiểm tra nếu giá trị rank đó không có trong mảng RANK phía trên
		if(!isset($RANK[$logged_in_rank]))
		{
			return false;
		}

		//Nếu giá trị rank của session user có trùng với các giá trị trong mảng RANK thì thực hiện lệnh dưới
